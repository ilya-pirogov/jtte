...
public class BeaconHandModel extends BaseTileModel {
    ...
    public void rotateCube(float y) {
        setRotateAngle(cube, cube.rotateAngleX, y, cube.rotateAngleZ);
    }
}
